...
if __name__ == '__main__':
    ...
    dist_init(method='normal')
    num_gpu = link.get_world_size()
    rank = link.get_rank()
    ...
    train_loader, test_loader = build_imagenet_data(batch_size=args.batch_size, workers=args.workers,
                                                    data_path=args.data_path, dist_sample=(num_gpu > 1))
    ...
    cali_data = get_train_samples(train_loader, num_samples=int(args.num_samples / num_gpu))
